...
When you have applications and business processes deployed on your Production environment you want to monitor those resources for their availability, performance, and operation. This chapter describes the monitoring data generated by Azure AI services.

## Azure AI services

[Monitor Azure AI Services](https://learn.microsoft.com/training/modules/monitor-cognitive-services/)
...
[Scaling strategies for large scale Azure Cognitive Services deployments](https://techcommunity.microsoft.com/t5/ai-azure-ai-services-blog/scaling-strategies-for-large-scale-azure-cognitive-services/ba-p/3819520)
...
Monitoring is a critical aspect of managing any service. Azure OpenAI is part of Azure AI services, which uses Azure Monitor, a powerful service that provides monitoring and analytics of Azure resources. This [guide](https://learn.microsoft.com/azure/ai-services/openai/how-to/monitoring) will help you understand how to monitor your Azure OpenAI resources effectively, ensuring optimal performance and availability.

### Business Continuity and Disaster Recovery (BCDR)

<TODO: should this be moved to another chapter?>

In today's digital world, ensuring business continuity and disaster recovery is crucial. Azure OpenAI is available in multiple regions, providing the flexibility to design your service for high availability. This [guide](https://learn.microsoft.com/azure/ai-services/openai/how-to/business-continuity-disaster-recovery) provides recommendations on how to implement BCDR for your Azure OpenAI applications, ensuring that your service remains available even in the rare event of a network issue affecting an entire region.

### Implementing Logging and Monitoring

This [architecture](https://learn.microsoft.com/azure/architecture/ai-ml/openai/architecture/log-monitor-azure-openai) provides advanced logging capabilities for tracking API usage and performance. It also offers robust security measures to protect sensitive data and prevent malicious activity, ensuring that your enterprise deployments are secure and efficient.
