...
nav_order: 12
has_children: false
title: Chapter 11 - Scaling and Quota Management
permalink: /chapters/chapter_11_expanding_horizons_scaling_quota_management
layout: default
---
...
- **Optimizing Azure OpenAI model deployments**: In the guide "[Optimizing Azure OpenAI: A Guide to Limits, Quotas, and Best Practices](https://techcommunity.microsoft.com/t5/fasttrack-for-azure/optimizing-azure-openai-a-guide-to-limits-quotas-and-best/ba-p/4076268)", Azure Customer Engineer Olga Molocenco-Ciureanu provides guidance to engineering teams adoption Azure OpenAI to optimize their quota and rate limits for model deployments. You will learn how to choose the right capacity allocations for your use cases, using Azure OpenAI's monitoring metrics to establish a baseline for your workloads, track usage, and set alerts to ensure that you are not over-allocating resources. The guide also provides strategies for ensuring the load on your Azure OpenAI deployments is balanced and how to handle unexpected spikes in usage.
